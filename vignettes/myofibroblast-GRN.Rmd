...
```{bash, eval=TRUE}
mkdir -p Fibroblast
wget -P -q Fibroblast https://costalab.ukaachen.de/open_data/scMEGA/Fibroblast/snRNA.rds
wget -P -q Fibroblast https://costalab.ukaachen.de/open_data/scMEGA/Fibroblast/snATAC.rds
wget -P -q Fibroblast https://costalab.ukaachen.de/open_data/scMEGA/Fibroblast/gene.activity.rds
```
...
ext, we will estimate distint network topological measures as node degree, node centrality and node page rank score and plot these in a principal component based embedding with a focus on transcription factors. We plot bellow the 3 first PCs. 
