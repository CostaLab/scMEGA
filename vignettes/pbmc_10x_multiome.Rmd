...
download.file('https://cf.10xgenomics.com/samples/cell-arc/2.0.0/pbmc_granulocyte_sorted_10k/pbmc_granulocyte_sorted_10k_atac_fragments.tsv.gz', 
              './10x_pbmc/pbmc_granulocyte_sorted_10k_atac_fragments.tsv.gz')

download.file('https://cf.10xgenomics.com/samples/cell-arc/2.0.0/pbmc_granulocyte_sorted_10k/pbmc_granulocyte_sorted_10k_atac_fragments.tsv.gz.tbi', 
              './10x_pbmc/pbmc_granulocyte_sorted_10k_atac_fragments.tsv.gz.tbi')

download.file('https://cf.10xgenomics.com/samples/cell-arc/2.0.0/pbmc_granulocyte_sorted_10k/pbmc_granulocyte_sorted_10k_filtered_feature_bc_matrix.h5', 
              './10x_pbmc/pbmc_granulocyte_sorted_10k_filtered_feature_bc_matrix.h5')
```
...
Download data
```{bash, eval=TRUE}
wget -q -P 10x_pbmc ftp://ftp.ebi.ac.uk/pub/databases/mofa/10x_rna_atac_vignette/seurat.rds
```
...
DimPlot(pbmc, 
        ...
        shuffle = TRUE, 
        label = TRUE, 
        reduction = "MOJITOO_UMAP") + NoLegend()
```
