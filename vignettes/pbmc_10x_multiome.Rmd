...
Load data
```{r}
reference <- readRDS("./raw_data/seurat.rds")
...
pbmc[["ATAC"]] <- CreateChromatinAssay(
  ...
  sep = c(":", "-"),
    min.cells = 1,
    genome = 'hg38',
    fragments = './raw_data/pbmc_granulocyte_sorted_10k_atac_fragments.tsv.gz'
)
```
...
obj <- AddTargetAssay(object = pbmc.t.cells, df.grn = df.grn2)
