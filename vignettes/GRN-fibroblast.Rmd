...
We then re-do the UMAP embedding and clustering with a lower resolution.
...
Marker genes are identified based on new clustering results.
...
we can also perform statistical test to check if any sub-popualtion are enriched in any of the above group. This can be down by the function _CompareCellProp_.
