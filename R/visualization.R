...
#' generated by the function \code{\link{GetTrajectory}}
#' @param df_cor A data frame containing the correlation between TF expression and
#' TF activity
#'
#' @return A heatmap
#' @export
#'
CorrelationHeatmap <- function(trajectory1, trajectory2, df_cor){
    trajMM2 <- trajectory1[df_cor$tfs, ]
    trajRNA2 <- trajectory2[df_cor$tfs, ]
