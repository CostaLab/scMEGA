#' Integrate single-cell gene expression and chromatin accessibility data.
#'
...
#' Pair the cells between different modalities based on the coembedding space
#'
...
#' @param tol
#' @param search.range
#' @param max.multimatch
#' @param min_subgraph_size
#' @param seed
#' @param k
#'
